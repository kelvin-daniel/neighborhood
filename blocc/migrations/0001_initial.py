    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('neighbourhood', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blocc.neighbourhood')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('healthservices', models.ManyToManyField(to='blocc.healthservices')),
                ('neighbourhood', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blocc.neighbourhood')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blocc.blogpost')),
                ('username', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='blogpost',
            name='neighbourhood',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='blocc.neighbourhood'),
        ),
        migrations.AddField(
            model_name='blogpost',
            name='username',
